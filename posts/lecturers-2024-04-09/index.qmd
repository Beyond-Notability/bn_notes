...
Comparison of chronology of extension/freelance
...
bn_lecturers_dates |>
  ...
  scale_fill_tableau() +
  theme(legend.position = "bottom") +
  labs(colour="position", fill="position", x="year", title = "Density chart of extension and freelance lecturing", caption = "excluding MM")
```
...
Timelines of individual positions per decade
...
the timeline chart for the individuals
