...
```{r finishing-up}
# finishing up: checked. RData  speakers-map-2024-05-22
# but not done anything to optimise.
```
...
```{r}
## from events 20240226 but for spoke at only. this is almost certainly over complicated for this purpose, but it was a complicated thing. it's pretty slow...
...
# get instance of for qualifiers - better to get them separately esp as there are multis etc
