...
Also I'm not sure if I can get clustering options to work, so at present you can only see one circle if there are several at the same location. Filtering will help sometimes. (The circles will be darker, and if there's an excavation and a person at the same spot there is a slight difference in colour, so you can get an idea of where it's happening.)
