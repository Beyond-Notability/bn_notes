...
```{r}
##interactive version. this is rubbish. quietly drp it.
...
bn_women_dates_ppa |>
  select(bn_id, personLabel, ppa_bucket, date_prop_label, prop_valueLabel, year, date_prop, person) |>
...
reactable(
  ...
  columns = list(
    ...
    date_prop_label = colDef(maxWidth = 160, name="activity"),
