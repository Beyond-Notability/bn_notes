...
```{r finishing-up}
# finishing up: checked. RData salrai-2023-11-09  minor text update.
...
People who *propose* at both societies constitute a very small group.
...
21 women engaged with both societies. 

This is not symmetrical: about 30% of women who engaged with RAI *also* engaged with SAL; but only 13% of women who engaged with SAL also engaged with RAI. Probably reflects the narrower subject area of RAI compared to SAL (I assume we'd see something similar for (eg) RHS).
