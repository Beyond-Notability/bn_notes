...
```{r finishing-up}
# finishing up: checked. RData lecturing-map-2024-04-30
```
...
```{r}
## don't like that it only shows one label when several items on one point. but cluster doesn't work with crosstalk.
```
