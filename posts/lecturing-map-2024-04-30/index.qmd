---
title: "A Map of Lecturing"
author: "Sharon Howard"
description: "Margaret Murray gets about."
date: "2024-04-30"
date-modified: today
categories: 
  - place
...
# this *only* added geos, not place names or io
...
pal <- colorFactor(c("navy", "brown"), domain = c("MM", "other"))
...
```{r}
## not got this to work right yet. don't like that it only shows one label when several items on one point. but cluster doesn't work with crosstalk.
# bscols(
#   widths = c(12,12,12),
...
#     bscols(
#       widths = c(7,5,6,6),
#     filter_slider(id="year", label = "year", sharedData = shared_map1, column=~year1),  # sep = "", # sep grrr.
...
#     filter_select(id="locality", label="area", sharedData = shared_map1, group = ~locality)
#     )
#   ),
#   
#   
#  # nb reactable filter doesn't do anyting to map even when crosstalk is working
# 
#   reactable(
